...
- For research findings: offer to proceed to `/writing-plans`
...
**Typical workflow:** `/deep-research` (swarm) → `/writing-plans` → `/team-execution` (agent teams) → `/review-swarm` (swarm)
