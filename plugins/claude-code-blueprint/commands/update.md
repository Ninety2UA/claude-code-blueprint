---
description: "Update the Claude Code Blueprint plugin to the latest version from GitHub."
---

# /update — Update Blueprint Plugin
...
- This command updates the **shared plugin cache** — all projects using the blueprint get the update
