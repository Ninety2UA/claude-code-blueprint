...
Note that files in `docs/plans/` and `docs/decisions/` are project documentation artifacts. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.
